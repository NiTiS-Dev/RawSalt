...
namespace RawSalt.Native.SDL;

public static class SDL2
{
	private const string LibraryName = "SDL2";
	private const string LibraryNameWindows = "SDL2.dll";
	private const string LibraryNameLinux = "libSDL2.so";

	static SDL2()
	{
		if (OperatingSystem.IsLinux())
		{
			NativeLibrary.SetDllImportResolver(typeof(SDL2).Assembly, LinuxLibraryResolver);
		}
		else if (OperatingSystem.IsWindows())
		{
			NativeLibrary.SetDllImportResolver(typeof(SDL2).Assembly, WindowsLibraryResolver);
		}
	}
	...
	{
		nint result = 0;
		if (!NativeLibrary.TryLoad(LibraryNameWindows, out result))
			NativeLibrary.TryLoad(NativePathResolver.GetAdditionalPath(LibraryNameWindows), out result);
	...
	public static unsafe string UTF8_ToManaged(IntPtr s, bool freePtr = false)
	{
		...
		/* Some SDL2 functions will malloc, we have to free! */
		if (freePtr)
		{
			SDL_free(s);
		}
	 ...
	 * Only available in SDL2 2.0.10 or higher.
	 */
	[DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
	...
	/* Only available in SDL2 2.0.1 or higher. */
	public const string SDL_HINT_VIDEO_HIGHDPI_DISABLED =
		"SDL_VIDEO_HIGHDPI_DISABLED";

	/* Only available in SDL2 2.0.2 or higher. */
	...
	/* Only available in SDL2 2.0.3 or higher. */
	...
	/* Only available in SDL2 2.0.4 or higher. */
	...
	private static IntPtr INTERNAL_AllocUTF8(string str)
	{
		...
		IntPtr mem = SDL2.SDL_malloc((IntPtr) bytes.Length);
	...
	/* This region only available in SDL2 2.0.10 or higher. */
	...
	/* These are for SDL_LoadBMP, which is a macro in the SDL2 headers. */
	/* IntPtr refers to an SDL_Surface* */
	...
	/* These are for SDL_SaveBMP, which is a macro in the SDL2 headers. */
	/* IntPtr refers to an SDL_Surface* */
	/* THIS IS AN RWops FUNCTION! */
	...
	public enum SDL_EventType : uint
	{
		...
		/* Only available in SDL2 2.0.14 or higher. */
		SDL_LOCALECHANGED,

		/* Display events */
		/* Only available in SDL2 2.0.9 or higher. */
...
#pragma warning restore 0169
	...
	public struct SDL_DropEvent
	{
		 ...
		 * string s = SDL2.UTF8_ToManaged(evt.drop.file, true);
		 */
		public IntPtr file;
		public UInt32 windowID;
	}
	...
	public enum SDL_Keymod : ushort
	{
		...
		/* These are defines in the SDL2 headers */
	...
	/* Capture the mouse, to track input outside an SDL2 window.
	 * Only available in 2.0.4 or higher.
	 */
	[DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
	 ...
	 * Only available in 2.0.18 or higher.
	 */
	[DllImport(LibraryName, EntryPoint = "SDL_GameControllerGetAppleSFSymbolsNameForButton", CallingConvention = CallingConvention.Cdecl)]
	 ...
	 * Only available in 2.0.18 or higher.
	 */
	[DllImport(LibraryName, EntryPoint = "SDL_GameControllerGetAppleSFSymbolsNameForAxis", CallingConvention = CallingConvention.Cdecl)]
	...
	/* Compare tick values, return true if A has passed B. Introduced in SDL2 2.0.1,
	...
	/* Returns the milliseconds that have passed since SDL2 was initialized */
	[DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
	...
	/* Only available in 2.0.16 or higher. */
	[DllImport(LibraryName, EntryPoint = "SDL_AndroidShowToast", CallingConvention = CallingConvention.Cdecl)]
	...
	/* Only available in SDL2 2.0.11 or higher. */
	[DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
